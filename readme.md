...
=== 4. Cara Menjalankan ===
Prasyarat: Python 3.7+ dan library matplotlib, numpy.
Instal library:
...
a. Grafik Perkembangan Fitness
   ...
   Interpretasi:
   - Awal: fitness rendah dan tersebar (eksplorasi)
   - Tengah: fitness naik drastis
   - Akhir: garis mendatar (konvergen ke solusi optimal)
...
b. Output Teks (Contoh)
   ...
   - Barang6
   - Barang8
   Penjelasan: Fitness 329 adalah total nilai barang terpilih. Total bobot = 20+11+9+10 = 50 (pas dengan kapasitas).
